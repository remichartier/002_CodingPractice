...
public class Multiples3And5_v01 {
    public static void main(String[] argm){

    	final int FACTOR[] = {3,5} ;
    	final int MAX = 1000 ;
    	int i = 0 ;
    	int n = 0 ;
    	int sum = 0 ;
...
/*
javac Multiples3And5_v01.java 
remi@HPPortable:~/00_Mirrored/tocopyhomepc/docs/025_Travail/trainings/26_ProgramExercizing/002_Java/20190820_ProjectEuleurMultiplesOf3And5$ java Multiples3And5_v01 
