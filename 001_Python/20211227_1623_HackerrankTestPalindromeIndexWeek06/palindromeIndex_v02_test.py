...
# Compiled successfully.13/15 test cases passed
'''
'''

# --> This version is to try to optimize the code.
...
s = "aaab"
print(f'PalindromeIndex({s}) = {palindromeIndex(s)}')
s = "baa"
print(f'PalindromeIndex({s}) = {palindromeIndex(s)}')
s = "aaa"
print(f'PalindromeIndex({s}) = {palindromeIndex(s)}')
print('should be : 3, 0, -1')
s = "a"
print(f'PalindromeIndex({s}) = {palindromeIndex(s)}')
s = "a"
print(f'PalindromeIndex({s}) = {palindromeIndex(s)}')
