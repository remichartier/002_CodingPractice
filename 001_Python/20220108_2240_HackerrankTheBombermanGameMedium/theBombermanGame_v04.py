...
def bombs_planted_exactly_three_seconds_ago_will_detonate(t, grid):
    ...
    # Here errors because manipulating arrays instead of strings ...
    ##################################################
    ...
    # equivalent design : need to handle strings instead of list of lists
    alt_grid = []
    for line in range(len(grid)):
