...
specific sub-stack.
	...
	--> This would mean that a stack size could be less than the maximum Capacity.
	But it is ok because stacks keep track of their sizes

	So it just have to test if index is within the number of stacks we have, and then pops
	from the stack.
