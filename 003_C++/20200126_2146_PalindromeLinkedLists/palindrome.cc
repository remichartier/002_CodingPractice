...
template <dataType> class LinkedList {
...
template <dataType> void testPartitionList(LinkedList<dataType> &lst, dataType value){
	lst.partitionList(value);
	lst.printLinkedList();
}

template <dataType> void testSumList(){
	LinkedList<dataType> l1 = LinkedList<dataType>(nullptr);
	LinkedList<dataType> l2 = LinkedList<dataType>(nullptr);
	LinkedList<dataType> t = LinkedList<dataType>(nullptr);
	...
	Node<dataType> * p1(l1.head) ;
	Node<dataType> * p2(l2.head) ;
	int carry(0);
...
template <dataType> int sumNodesForward(Node<dataType> * p1,Node<dataType> * p2, Node<dataType> * pt){
...
template <dataType> void equalizeListLengthForForwardListSum(LinkedList<dataType> & l1,LinkedList<dataType> & l2) {
...
template <dataType> void testSumListForwardOrder(){
	LinkedList<dataType> l1 = LinkedList<dataType>(nullptr);
	LinkedList<dataType> l2 = LinkedList<dataType>(nullptr);
	LinkedList<dataType> t = LinkedList<dataType>(nullptr);
