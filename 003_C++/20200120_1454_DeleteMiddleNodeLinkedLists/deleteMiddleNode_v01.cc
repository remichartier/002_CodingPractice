/* Description :
algo to delete a node in the middle 
(ie any node but the first and last node, not necessarily the exact node)
of a singly linked list, given only access to that node.

Ex : 
input : the node c from linked list a/b/c/d/e/f
Result : nothing is returned , but the new liked list looks like a/b/d/e/f
